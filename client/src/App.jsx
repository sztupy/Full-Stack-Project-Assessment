...
const App = () => {
	...
	return (
		<>
			...
			<h2 className="notice">Welcome to this demo solution for the <a href="https://github.com/CodeYourFuture/Full-Stack-Project-Assessment/">Code Your Future full stack assessment project</a>. Feel free to play around on this page. However do note that any data you enter on this website will be cleared and reset every 30 minutes.</h2>
